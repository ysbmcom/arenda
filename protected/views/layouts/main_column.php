...
<aside class="regular">
	...
	<div class="scroll-sidebar scroll-pane">
		...
		<div class="rooms-amount">
			...
			<li><label>2<input type="checkbox" name="rooms-amount" checked="checked"/></label></li>
		...
		<div class="advanced-filter hidden-wrap">
                    ...
                    <div class="advanced-field hidden">
                        <ul>
                            ...
                            <li><label class="checkbox disabled"><input type="checkbox" disabled />Красногвардейский</label></li>
